...
class Ravcheck {
    ...
    /**
     * Obtém caminho do arquivo de links
     * @returns {string} Caminho absoluto do arquivo
     */
    getLinksFilePath() {
        return path.join(this.baseDir, 'links.txt');
    }

    /**
     * Obtém caminho do arquivo de tags
     * @returns {string} Caminho absoluto do arquivo
     */
    getTagsFilePath() {
        return path.join(this.baseDir, 'tags.txt');
    }
     ...
     */
    loadUrls() {
        return this.optionsManager.loadUrls();
    }
     ...
     */
    addUrl(url) {
        this.optionsManager.addUrl(url);
    }

    /**
     * Adiciona tag ao arquivo tags.txt corretamente
     * @param {string} tag - Tag para adicionar
     */
    addTag(tag) {
        this.optionsManager.addTag(tag);
    }

    /**
     * Salva URLs no arquivo links.txt
     * @param {string[]} urls - Lista de URLs para salvar
     */
    saveUrls(urls) {
        this.optionsManager.saveUrls(urls);
    }

    /**
     * Salva tags personalizadas no arquivo tags.txt corretamente
     * @param {string[]} tags - Lista de tags personalizadas para salvar
     */
    saveTags(tags) {
        this.optionsManager.saveTags(tags);
    }

    /**
     * Obtém apenas tags personalizadas (sem as fixas)
     * @returns {string[]} Lista de tags personalizadas
     */
    loadCustomTags() {
        return this.optionsManager.loadTags();
    }
